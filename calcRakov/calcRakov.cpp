...
// calcRakov.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CcalcRakovApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CcalcRakovApp

CcalcRakovApp::CcalcRakovApp()
{
...
// Единственный объект CcalcRakovApp

CcalcRakovApp theApp;


// Инициализация CcalcRakovApp

BOOL CcalcRakovApp::InitInstance()
{
